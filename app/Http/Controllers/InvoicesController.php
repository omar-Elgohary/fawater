...
class InvoicesController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        // Notifications By DataBase
        // دي لو هبعت الاشعار لكل المستخدمين اللي عندي
        // $user = User::get();
        // $invoices = Invoices::latest()->first();
        // Notification::send($user , new AddInvoice($invoices));

        // دي لو انا عايز الاشعار يروح للشخص اللي عمل الاشعار بس
        // $user = User::find(Auth::user()->id);
        // $invoices = Invoices::latest()->first();
        // Notification::send($user , new AddInvoice($invoices));

        // دي لو عايز الادمن بس هو اللي يشوف الاشعارات بس محدش تاني يشوفها
        $user = User::get();
        $invoices = Invoices::latest()->first();
        Notification::send($user , new AddInvoice($invoices));
