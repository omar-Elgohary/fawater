...
<div class="col-lg-3">
    <label class="rdiobox">
        <input type="radio" name="rdio" value="1" id="type_div" checked><span>بحث بنوع الفاتورة</span></label>
</div>

<div class="col-lg-3 mg-t-20 mg-lg-t-0">
    <label class="rdiobox">
        <input type="radio" name="rdio" value="2"><span>بحث برقم الفاتورة</span></label>
</div><br><br>
